...
extension GardenAPI.Worlds {
    ...
    This will get a world
    */
    public enum GetWorld {

        public static let service = APIService<Response>(id: "getWorld", tag: "Worlds", method: "GET", path: "/world/{worldID}", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetWorld.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(worldID: String) {
